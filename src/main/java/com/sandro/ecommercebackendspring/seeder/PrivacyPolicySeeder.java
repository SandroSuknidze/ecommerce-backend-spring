...
import com.sandro.ecommercebackendspring.policy.repository.PrivacyPolicyRepository;
...
public class PrivacyPolicySeeder {
    ...
    public void seedPrivacyPolicy() {
        if (privacyPolicyRepository.count() == 0) {
            privacyPolicyRepository.save(new PrivacyPolicy("""
