...
import com.sandro.ecommercebackendspring.policy.repository.RefundPolicyRepository;
...
public class RefundPolicySeeder {


    private final RefundPolicyRepository refundPolicyRepository;

    @PostConstruct
    public void seedRefundPolicy() {
        if (refundPolicyRepository.count() == 0) {
            refundPolicyRepository.save(new RefundPolicy("""
                    <p><br>Last updated: March 09, 2023</p>
                    ...
                    <ul>
                      ...
                      <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where control means ownership of 50 percent or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                      <li><strong>Company</strong> (referred to as either the Company, We, Us or Our in this Agreement) refers to Blueskytech, 268 St, South New York/NY 98944, United States.</li>
                      ...
                      <li><strong>Website</strong> refers to Umino, accessible from <a href=https://blueskytechmage.com/gota/>https://blueskytechmage.com/gota/</a>.</li>
